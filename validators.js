...
const instructionInitiateSchema = Joi.object({
    ...
    sender: Joi.string()
        ...
        .required()
        .messages({
            'string.pattern.base': 'Sender ID must contain only letters, numbers, underscores, and hyphens'
        }),
    ...
    recipient: Joi.string()
        ...
        .required()
        .messages({
            'string.pattern.base': 'Recipient ID must contain only letters, numbers, underscores, and hyphens'
        }),
...
const adapterExecuteSchema = Joi.object({
    ...
    adapter: Joi.string().valid('ADAPTER_PAYNOW', 'ADAPTER_SWIFT', 'ADAPTER_CRYPTO_CUSTODIAN', 'ADAPTER_BROKERAGE_SETTLEMENT').required()
});
